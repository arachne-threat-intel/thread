...
class Dao:
    ...
    async def get(self, table, equal=None, not_equal=None, order_by_asc=None, order_by_desc=None):
        return await self.db.get(
            table, equal=equal, not_equal=not_equal, order_by_asc=order_by_asc, order_by_desc=order_by_desc
        )
    ...
    async def get_dict_value_as_key(self, column_key, table=None, columns=None, sql=None, sql_params=None):
        return await self.db.get_dict_value_as_key(
            column_key, table=table, columns=columns, sql=sql, sql_params=sql_params
        )
