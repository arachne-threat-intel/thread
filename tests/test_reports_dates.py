...
class TestReportDates(ThreadAppTest):
    ...
    async def test_missing_date_written(self):
        ...
        self.assertTrue(
            "Article Publication Date missing" in error_msg,
    ...
    async def test_incorrect_report_date_order(self):
        ...
        self.assertTrue(
            "Incorrect ordering of dates provided" in error_msg,
    ...
    async def test_report_dates_outside_tech_dates(self):
        ...
        self.assertTrue(
            "1 confirmed technique has start/end dates outside specified range" in error_msg,
    ...
    async def test_tech_missing_start_date(self):
        ...
        self.assertTrue(
            "Technique Start Date missing" in error_msg,
